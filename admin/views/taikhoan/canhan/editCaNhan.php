            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        ...
                        onerror="this.onnerror=null; this.src='https://upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png'">
                        <h6>Họ và tên: <?= $thongTin['ho_ten'] ?> </h6>
                ...
                <div class="col-md-9 personal-info">
                    <form action="<?= BASE_URL_ADMIN . '?act=sua-thong-tin-ca-nhan-quan-tri' ?>" method="post">
                        ...
                        <div class="form-group">
                            <label class="col-lg-12 control-label">Họ tên:</label>
                            <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            <label class="col-lg-12 control-label">Time Zone:</label>
                            <div class="col-lg-12">
                                <div class="ui-select">
