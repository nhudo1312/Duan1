...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-11">
                    <h1>Sua thong tin sản phẩm: <?= $sanPham['ten_san_pham'] ?></h1>
                </div>
                <div class="col-sm-1">
            ...
            <div class="col-md-8">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Thong tin chung</h3>
                    ...
                    <form action="<?= BASE_URL_ADMIN . '?act=sua-san-pham' ?>" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="mo_ta" class="form-control" name="mo_ta" rows="4"><?= $sanPham['mo_ta'] ?>
                            </textarea>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($listAnhSanPham as $key => $value): ?>
                                        <tr id="faqs-row-<?= $key ?>">
                                            ...
                                            <td><img src="<?= BASE_URL . $value['link_hinh_anh'] ?>" style="width:50px;heigth:50px"></td>
...
<script>
    ...
    function addfaqs() {
        ...
        html += '<td><img src="https://cdn-images.vtv.vn/2019/10/10/photo-1-15706463929181755249740.jpg" style="width:50px;heigth:50px"></td>';
